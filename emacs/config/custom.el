(custom-set-variables
 ...
 '(package-selected-packages
   '(helm-rg helm-projectile helm helm-core perspective use-package editorconfig lsp-treemacs typescript-mode csv-mode sokoban vue-html-mode vue-mode tide magit-filenotify magit-find-file apache-mode ibuffer-vc lsp-java lsp-ui flycheck lsp-mode evil-numbers docker docker-compose-mode dockerfile-mode magit edit-server perlcritic projectile smart-tab copy-as-format jira org-jira yaml-mode web-mode string-inflection sqlup-mode sql-indent smart-tabs-mode puppet-mode pde org-tree-slide org-pomodoro markdown-mode magit-gh-pulls ibuffer-projectile helm-perldoc helm-make helm-gtags helm-ag groovy-mode git-link ggtags format-sql flymake-ruby flymake-python-pyflakes flymake-puppet flymake-perlcritic flymake-json flymake-css evil-org dired-k date-at-point clojure-mode bool-flip bind-key atom-one-dark-theme angularjs-mode airline-themes aggressive-indent))
