(custom-set-variables
 ...
 '(git-commit-setup-hook
   '(git-commit-ensure-comment-gap git-commit-save-message git-commit-turn-on-auto-fill git-commit-mode) t)
